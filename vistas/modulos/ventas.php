...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <a onclick="changeContent('content-wrapper','vistas/modulos/ventas/newSale.php')" class="btn btn-info btn-sm mb-4" style="cursor: pointer;">
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#tablaCategorias").DataTable({
            "ajax": {
                "url": "ajax/saleProducts.ajax.php",
                "type": "POST",
                "dataSrc": ""
            },
            "columnDefs": [{
        ...
        $('#tablaCategorias tbody').on('click', '.btnEliminar', function() {
            ...
            datos.append('id', id);
            datos.append('idProduct', data["product"]);
            swal.fire({
                title: "Confirma!",
                text: "Seguro que desea eliminar esta venta?",
                icon: 'warning',
